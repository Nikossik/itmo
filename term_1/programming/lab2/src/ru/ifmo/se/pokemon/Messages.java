...
public class Messages extends ListResourceBundle {
   ...
   private static Object[][] contents = new Object[][]{
      ...
      {"attack", "attacks"},
      {"struggle", "struggles"},
      {"noattack", "does nothing"},
      {"confusion", "hits himself in confusion"},
      {"noeffect", "isn't affected by"},
      {"miss", "misses"},
      {"teams", teams},
      {"from", "from the team"},
      {"enter", "enters the battle!"},
      {"tie", "Both teams are out of Pokemons. It's a tie!"},
      {"inTeam", "Team"},
      {"empty", "loses its last Pokemon."},
      {"team", "The team"},

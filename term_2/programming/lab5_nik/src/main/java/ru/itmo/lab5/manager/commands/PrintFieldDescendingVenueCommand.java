...
public class PrintFieldDescendingVenueCommand extends Command {
    ...
    public void execute(String[] args) {
        ...
        if (venues.isEmpty()) {
            System.out.println("В коллекции нет элементов с заданным полем venue или коллекция пуста.");
        } else {
            System.out.println("Значения поля venue всех элементов в порядке убывания:\n" + venues);
        }
    }
}
